        ...
        while True:
            ...
            while n1 >= 2:
                ...
                for item in sts2:
                    lst3 = lst[:]
                    lst3.append(item)
                    if survey.score_students(lst3) > \
                            survey.score_students(lst2):
                        lst2 = lst3
                        maxidx = idx
                    idx += 1
            ...
            # grouping.add_group(lst3)
            out.add_group(Group(lst3))
