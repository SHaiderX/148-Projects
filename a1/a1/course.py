...
class Student:
    ...
    === Private Attributes ===
    _qs: A dictionary mapping a question to it's answer.
    ...
    def has_answer(self, question: Question) -> bool:
        ...
        """
        # TODO: complete the body of this method
        if question in self._qs:
            return question.validate_answer(self._qs[question])
        return False
